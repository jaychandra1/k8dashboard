    ...
    <div className="sec-view">
      ...
      <div className="sec-setup">
        ...
        {canScan ? (
          <>
            <p>
              Run a <strong>built-in image scan</strong> right now — k8sight scans every image your cluster is running with Trivy{scanAvail.version ? ` (${scanAvail.version})` : ''}. <strong>Nothing to install in your cluster.</strong>
