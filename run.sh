...
# ("open http://127.0.0.1:3001/#token=…"); set KUBEPILOT_TOKEN to choose it.
#
set -euo pipefail
...
run_prod() {
  ...
  info "Starting KubePilot (production)"
...
run_dev() {
  ...
  info "Starting KubePilot (dev — hot reload)"
