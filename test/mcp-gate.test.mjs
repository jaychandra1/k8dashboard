// The MCP write gate: mcp.js calls the REST API with `X-K8sight-Source: mcp`.
...
describe('MCP write gate (writes disabled)', () => {
  test('POST /api/apply with X-K8sight-Source: mcp → 403 mcp_write_disabled', async () => {
  ...
  test('the gate still applies inside demo mode', async () => {
    ...
    const list = await srv.authed('/api/resources/default', { headers: { 'X-K8sight-Source': 'mcp' } });
