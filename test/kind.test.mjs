...
// Imported from the registry itself (kinds.js): kind.js is a Vite-only shim that
// re-exports from an extensionless './kinds' specifier Node's ESM loader rejects.
import { kindType, KIND_TYPE } from '../client/src/lib/kinds.js';
